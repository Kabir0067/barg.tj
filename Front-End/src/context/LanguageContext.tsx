...
const translations: Record<Language, Record<string, string>> = {
  tj: {
    ...
    home_feat_1_desc: 'Агар маблағи харид аз 500 сомонӣ зиёд бошад, расонидан тамоман ройгон аст.',
  ...
  ru: {
    ...
    home_feat_1_desc: 'При заказе товаров на сумму от 500 сомони доставка абсолютно бесплатна.',
    ...
    prod_hero_delivery: 'Бесплатная доставка от 500 сомони',
