...
def client_chat(request):
    ...
    if lang == 'ru':
        system_prompt = (
            ...
            "3. Правила доставки: при заказе от 500 сомони доставка бесплатная. До 500 сомони доставка стоит 20 сомони.\n"
        ...
        system_prompt = (
            ...
            "3. Қоидаи дастраскунӣ: барои фармоиши зиёда аз 500 сомонӣ дастраскунӣ комилан ройгон аст. То 500 сомонӣ нархи дастраскунӣ 20 сомонӣ аст.\n"
